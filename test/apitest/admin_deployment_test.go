...
func TestAdminListDeploymentsEndpoint(t *testing.T) {
	...
	setupTestData := func(t *testing.T, ctx context.Context, ds dbaccess.DataSource) {
		...
		fixture.InsertToken(t, ctx, ds, "user-token", actor2.ID, []string{"user"})
	}
...
func TestAdminRejectDeploymentEndpoint(t *testing.T) {
	...
	setupTest := func(t *testing.T) (*httptest.Server, dbaccess.DataSource, int64) {
		...
		actor1 := fixture.InsertActor(t, ctx, ds, "actor1")
		fixture.InsertToken(t, ctx, ds, "reviewer-token", actor1.ID, []string{"admin"})
		fixture.InsertToken(t, ctx, ds, "non-reviewer-token", actor1.ID, []string{"admin"})
